; The actual fungible-v2 contract contains incorrect formal verification
; assertions and results in vacuous property warnings when verifying contracts
; that rely on it (at least as of Pact 4.6).
;
; This version of the fungible-v2 contract is an alternative for local use that
; won't throw up formal verification errors. See also:
; https://github.com/kadena-io/pact/issues/1136
; https://github.com/kadena-io/chainweb-node/pull/1595
